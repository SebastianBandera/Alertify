...
public class StringUtils {
	...
	public final static String concatObject(Object ... args) {
		return concatObject(50, args);
	}
	
	public final static String concatObject(int stringLengthAverage, Object ... args) {
	...
	public final static String grammaticalInflectionByNumber(String text, char flagSingular, char flagPlural, boolean isSingular) {
		...
		for (int i = 0; i < originalChars.length; i++) {
			if (skip) {
				...
				if (c == flagPlural && !isSingular || c == flagSingular && isSingular) {
					skip = true;
				} else {
					chars[charsFound++] = c;
				}
