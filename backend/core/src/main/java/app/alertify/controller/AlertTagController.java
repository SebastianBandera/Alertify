...
public class AlertTagController {
    ...
    private final AlertTagService service;

    public AlertTagController(AlertTagService service) {
        this.service = service;
    }

    @GetMapping
    public Page<TagResponse> search(@RequestParam MultiValueMap<String, String> params,
