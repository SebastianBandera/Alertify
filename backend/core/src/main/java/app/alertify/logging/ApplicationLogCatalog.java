...
class ApplicationLogCatalog {
    ...
    private final ConcurrentMap<String, ApplicationLogLevelDefinition> levels = new ConcurrentHashMap<>();
    private final ConcurrentMap<String, ApplicationLogSource> sources = new ConcurrentHashMap<>();
    private final ConcurrentMap<String, ApplicationLogEvent> events = new ConcurrentHashMap<>();

    ApplicationLogCatalog(ApplicationLogLevelDefinitionRepository levelRepository, ApplicationLogSourceRepository sourceRepository, ApplicationLogEventRepository eventRepository) {
