 ...
 */
@ProcedureTemplate(
    nameKey = "procedures.template.devtools.simulatedLongRunningPlaywright.name",
    descriptionKey = "procedures.template.devtools.simulatedLongRunningPlaywright.description",
    tags = @ProcedureTemplateTag(nameKey = "procedures.templateTag.development"),
    capability = WorkerCapability.PLAYWRIGHT,
    sourcePath = "app/alertify/procedures/templates/devtools/SimulatedLongRunningPlaywrightProcedureTemplate.java"
)
public final class SimulatedLongRunningPlaywrightProcedureTemplate implements ProcedureEvaluator {
    ...
    public SimulatedLongRunningPlaywrightProcedureTemplate(long sleepMilliseconds, boolean randomInitialDelayEnabled, long randomInitialDelayMinSeconds, long randomInitialDelayMaxSeconds) {
